...
主动道具包括激光、追踪导弹、地雷和霰弹。持有主动道具时，主要射击键会优先释放并消耗它；没有主动道具时发射普通子弹。`E`、`.` 和鼠标右键暂时保留为兼容快捷键。护盾、快速射击和双发属于拾取后自动生效的被动道具，不会拦截普通射击。
...
P0 工程基线、P1-A 三人本地模式、P1-B 暂停设置和 P1-C 统一武器输入已经完成；P1 后续将继续实现经典特殊武器。
